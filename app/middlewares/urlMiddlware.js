...
module.exports = {
    ...
    */
    getUrlParameter: async(req, res, next)=>{
        if(!req.body.userId || !req.body.midToken){
        ...
        const midToken =  await aes.decrypt(req.body.midToken);

        const userToken = midToken.split('|');
        ...
        console.log(userToken[1], secretCode[1])
